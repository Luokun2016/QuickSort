var Showbo={author:'showbo',homepage:'172.19.8.200'};  
//是否为ie浏览器  
...
Showbo.Msg={  
    ...
    InitMsg:function(width){  
      ...
      html='<div class="top"><div class="right"><div class="title" id="dvMsgTitle"></div></div></div>'+  
        ...
        '<div class="bottom" id="dvMsgBottom"><div class="right"><div class="mybtn" id="dvMsgBtns"></div></div></div>';  
    ...
    createBtn:function(p,v,fn){  
        ...
        btn.onmouseout=function(){this.className='mybtn';}  
        btn.onclick=function(){  
          Showbo.Msg.hide();
          //if(fn)fn(p);
           // alert(Showbo.result);
           if(p == 'yes' && Showbo.Msg.oncallback != null){
              Showbo.Msg.oncallback();
              Showbo.Msg.oncallback=null;
            }
    ...
    errorMsg:function(msg){  
      this.show({buttons:{yes:'确认'},msg:msg,title:'提示'});  return false;
    },   
    alert:function(msg){  
      this.show({buttons:{yes:'确认'},msg:msg,title:'消息'});  return false;
    },  
