...
(function (a, b)
{
  ...
  {
    var c;
    b.nodeType === 1 && (b.clearAttributes && b.clearAttributes(), b.mergeAttributes && b.mergeAttributes(a), c = b.nodeName.toLowerCase(), c === "object" ? b.outerHTML = a.outerHTML : c !== "input" || a.type !== "checkbox" && a.type !== "radio" ? c === "option" ? b.selected = a.defaultSelected : c === "input" || c === "textarea" ? b.defaultValue = a.defaultValue : c === "script" && b.text !== a.text && (b.text
             = a.text) : (a.checked && (b.defaultChecked = b.checked = a.checked), b.value !== a.value && (b.value = a.value)), b.removeAttribute(f.expando), b.removeAttribute("_submit_attached"), b.removeAttribute("_change_attached"))
  }
  function bj(a, b)
  {
  ...
  f = function ()
  {
    ...
    e.fn = e.prototype =
    {
      ...
      pushStack : function (a, b, c)
      {
        ...
        b === "find" ? d.selector = this.sel
          ector + (this.selector ? " " : "") + c : b && (d.selector = this.selector + "." + b + "(" + c + ")");
        return d
      },
      each : function (a, b)
      {
    ...
    {
      c.
      readyState === "complete" && (c.detachEvent("onreadystatechange", B), e.ready())
    }
    );
    return e
  }
  ...
  x =
  {
    ...
    {
      var d;
      b === !1 ? f.removeAttr(a, c) : (d = f.propFix[c] || c, d in a && (a[d] = !0), a.setA
        ttribute(c, c.toLowerCase()));
      return c
    }
  },
  v || (y =
  ...
  f.event =
  {
    ...
    remove : function (a, b, c, d, e)
    {
      ...
      if (!!g && !!(o = g.events))
      {
        ...
        for (h = 0; h < b.length; h++)
        {
          ...
          r.length === 0 && m !== r.length && ((!p.teardow
              n || p.teardown.call(a, l) === !1) && f.removeEvent(a, j, g.handle), delete o[j])
        }
    ...
    dispatch : function (c)
    {
      ...
      if (!i.preDis
        patch || i.preDispatch.call(this, c) !== !1)
      {
  ...
  f.support.submitBubbles || (f.event.special.submit =
    {
      setup : function ()
      {
        ...
        f.event.add(this, "click._submit keypress._submit", function (a)
        {
          var c = a.target,
          d = f.nodeName
            (c, "input") || f.nodeName(c, "button") ? c.form : b;
  ...
  function ()
  {
    ...
    {
      var b = (a ? a.o
        wnerDocument || a : 0).documentElement;
  ...
  f.fn.extend(
  {
    load : function (a, c, d)
    {
      ...
      var h = "GET";
      c && (f.isFunction(c) ? (d = c, c = b) : typeof c == "object" && (c = f.param(c, f.ajaxSettings.tra
              ditional), h = "POST"));
      var i = this;
      f.ajax(
      {
  ...
  f.extend(
  {
    ...
    ajax : function (a, c)
    {
      ...
      (d.data && d.hasContent && d.contentType !== !1 || c.contentType) && v.setRequestHea
      der("Content-Type", d.contentType),
  ...
  f.ajaxSetup(
  {
    accepts :
    {
      ...
      n/ecmascript, application/x-ecmascript"
    },
    contents :
    {
    ...
    if (!c.crossDomain || f.support.cors)
    {
      ...
      return
      {
        send : function (e, g)
        {
          ...
          !c.async || h.readyState === 4 ? d() : (i = ++cf, ce && (cg || (cg = {}, f(a).unload(ce)), cg[i] = d), h.onreadystat
            echange = d)
        },
        abort : function ()
        {
    ...
    animate : function (a, b, c, d)
    {
      function g()
      {
        ...
        for (g in a)
        {
          ...
          c && (g === "height" || g === "width") && (b.o
            verflow = [this.style.overflow, this.style.overflowX, this.style.overflowY], f.css(this, "display") === "inline" && f.css(this, "float") === "none" && (!f.support.inlineBlockNeedsLayout || cu(this.nodeName) === "inline" ? this.style.display = "inline-block" : this.style.zoom = 1))
        }
  ...
  f.extend(
  {
    speed : function (a, b, c)
    {
      ...
      d.complete = function (a)
      {
        ...
        d.queue ? f.dequeue(this, d.
          queue) : a !== !1 && f._unmark(this)
      };
      return d
    },
    easing :
   ...
   : cv = function (a, b, c)
  {
    ...
    while ((a = a.parentNode) && a !== h && a !== c)
    {
      ...
      f.support.subtractsBorderForOverflowNotVisible && d.overflow !== "visible"
  ...
  }, function (a, c)
  {
    ...
    f.fn[a] = function (e)
    {
      return f.access(this, function (a, e, g)
      {
        var h = cy(a);
        if (g === b)
          return h ? c in h ? h[c] : f.support.boxModel && h.document.documentElement[e] || h.document.bod
          y[e] : a[e];
