...
(function(e) {
	...
	e.fn.jElevator = function(i) {
		...
		this.createInDomTree = function() {
			...
			// alert(r);
			o.each(function(t, r) {
				n += '<li><a href="javascript:;">' + e(r).text() + "</a></li>"
			});
			var r = "";
			if (s.showTopButton) {
				!s.showSectionsMenu && !s.showBottomButton ? r = " full-height" : s.showSectionsMenu || (r = " half-height");
				t += '<a href="javascript:;" title="Scroll to Top" class="jelevator-scroll-top' + r + '"><span>&nbsp;</span></a>'
			}
			if (s.showSectionsMenu) {
				!s.showTopButton && !s.showBottomButton && (r = " full-height");
				t += '<a href="javascript:;" class="jelevator-menu' + r + '"><span>&nbsp;</span></a>'
			}
			if (s.showBottomButton) {
				!s.showTopButton && !s.showSectionsMenu ? r = " full-height" : s.showSectionsMenu || (r = " half-height");
				t += '<a href="javascript:;" class="jelevator-scroll-bottom' + r + '"><span>&nbsp;</span></a>'
			}
			var i = '<div class="jelevator-navi-items"><ul>' + n + "</ul></div>",
				u = '<div class="jelevator"><div class="jelevator-navigation">' + t + "</div>" + (s.showSectionsMenu ? i : "") + "</div>";
			t !== "" && e("body").append(u)
		};
		this.onShowMenuBtnClick = function(t) {
			if (e(".jelevator-navigation").hasClass("open")) n.closeItemsPanel(t);
				...
				e(".jelevator-navi-items").css({
					left: -1 * e(".jelevator-navi-items").width(),
					display: "block"
				});
		...
		this.onMenuItemClick = function() {
			var t = e(this).index("ul a"),
				r = e(o.get(t)).position().top;
			n.scrollToPosition(r);
			return !1
		};
		this.onMouseMove = function(t) {
			t.stopImmediatePropagation();
			var r = t.clientX > 0 ? t.clientX : 1,
				i = parseInt(100 / parseInt(e(document).width() / r, 10), 10),
				s = !1;
