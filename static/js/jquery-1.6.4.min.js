...
(function (a, b)
{
  ...
  f = function ()
  {
        ...
        if ((a = arguments[j]) != null)
          for (c in a)
          {
            ...
            l && f && (e.isPlainObject(f) || (g = e.isArray(f))) ? (g ? (g = !
                  1, h = d && e.isArray(d) ? d : []) : h = d && e.isPlainObject(d) ? d : {}, i[c] = e.extend(l, h, f)) : f !== b && (i[c] = f)
          }
      return i
    },
    e.extend(
    {
      ...
      parseXML : function (c)
      {
        ...
        (!d || !d.documentElement || d.getElementsByTagName("parsererror").length) && e.error("Invalid XML:
           " + c);
        return d
      },
      noop : function ()  {},
  ...
  f.event =
  {
    ...
    props : "altKey attrChange attrName bubbles button cancelable charCode clientX clientY ctrlKey currentTarget data detail event
    Phase fromElement handler keyCode layerX layerY metaKey newValue offsetX offsetY pageX pageY prevValue relatedNode relatedTarget screenX screenY shiftKey srcElement target toElement view wheelDelta which".split(" "),
    fix : function (a)
    {
      if (a[f.expando])
        return a;
  ...
  f.Event.prototype =
  {
    preventDefault : function ()
    {
      ...
      !a || (a.preventDefault ? a.pre
        ventDefault() : a.returnValue = !1)
    },
    ...
    var l = k.selectors =
    {
      ...
      relative :
      {
        ...
        "~" : function (a, b, c)
        {
          ...
          g = u;
          type
          of b == "string" && !j.test(b) && (b = b.toLowerCase(), e = b, g = t),
  ...
  f.extend(
  {
    ...
    ajax : function (a, c)
    {
      ...
      d.crossDomain == null && (r = bN.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] == bS[1] && r[2]
           == bS[2] && (r[3] || (r[1] === "http:" ? 80 : 443)) == (bS[3] || (bS[1] === "http:" ? 80 : 443)))),
  ...
  f.ajaxPrefilter("json jsonp", function (b, c, d)
  {
    ...
    if (b.dataTypes[0] === "jsonp" || b.jsonp !== !1 && (ca.test(b.url) |
         | e && ca.test(b.data)))
    {
      var g,
  ...
  f.extend(
  {
    speed : function (a, b, c)
    {
      ...
      d.complete = function (a)
      {
        ...
        d.queue!
         == !1 ? f.dequeue(this) : a !== !1 && f._unmark(this)
      };
      return d
    },
    easing :
   ...
   : f.fn.offset = function (a)
  {
    ...
    while ((b = b.parentNode) && b !== i && b !== h)
    {
      ...
      f.offset.subtractsBorderForOverflowNotVisible && c.overflow !== "
